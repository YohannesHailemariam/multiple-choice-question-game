...
function Signin() {
  ...
  return (
    <div className='flex mt-14 items-center justify-center mt-[200px]'>
        <form className='w-[380px] pt-10 pr-10 pb-10 pl-5 bg-[#fafafa] border-[1px] border-[#ebebeb] shadow shadow-lg'>
            ...
            <div className="relative mb-[45px]">
                <input className='text-18 pb-[10px] pr-[10px] pb-[10px] pl-[5px] appearance-none block bg-[#fafafa] text-[#636363] w-full border border-0 border-b border-solid border-gray-600 outline-none' type="email" /><span className="absolute h-[60%] w-[100px] top-[25%] left-0 pointer-events-none opacity-50 highlight"></span><span className="relative block w-[100%] bar"></span>
            ...
            <div class="relative mb-[45px]">
                <input className='text-18 pb-[10px] pr-[10px] pb-[10px] pl-[5px] appearance-none block bg-[#fafafa] text-[#636363] w-full border border-0 border-b border-solid border-gray-600 outline-none' type="password" /><span className="absolute h-[60%] w-[100px] top-[25%] left-0 pointer-events-none opacity-50 highlight"></span><span className="relative block w-[100%] bar"></span>
